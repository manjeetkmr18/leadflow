...
import { ArrowRight, Eye, EyeOff, Mail, Lock, User, Github, Chrome } from 'lucide-react'
    ...
    <div className="min-h-screen">
      ...
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-black dark:to-gray-800 pt-20">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-black/60 dark:text-white/60">Join CRMFlow and start managing your customers</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-start">
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-4 h-4 mt-1 text-black dark:text-white bg-white/30 dark:bg-black/30 border-black/20 dark:border-white/20 rounded focus:ring-black/30 dark:focus:ring-white/30 focus:ring-2"
                  required
                />
                <label htmlFor="agreeToTerms" className="ml-2 text-sm text-black/70 dark:text-white/70">
                  I agree to the{' '}
              ...
              <button type="submit" className="w-full relative overflow-hidden group backdrop-blur-md">
                {/* Glassmorphism background */}
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-600/80 to-teal-600/80 dark:from-emerald-500/80 dark:to-teal-500/80 backdrop-blur-md border border-emerald-500/30 dark:border-emerald-400/30 rounded-lg shadow-lg shadow-emerald-500/20 dark:shadow-emerald-400/20 transition-all duration-300 group-hover:from-emerald-700/90 group-hover:to-teal-700/90 dark:group-hover:from-emerald-400/90 dark:group-hover:to-teal-400/90 group-hover:border-emerald-400/50 dark:group-hover:border-emerald-300/50 group-hover:shadow-xl group-hover:shadow-emerald-500/30 dark:group-hover:shadow-emerald-400/30"></div>
                {/* Inner glow */}
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-400/20 via-teal-400/20 to-emerald-400/20 dark:from-emerald-300/20 dark:via-teal-300/20 dark:to-emerald-300/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                {/* Button content */}
